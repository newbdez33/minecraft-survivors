...
static func test_sword_starts_at_wood_tier() -> bool:
	...
	var result = sword.current_tier == SwordBase.Tier.WOOD
	sword.queue_free()
	return result

# Test: Wood sword has correct base damage
static func test_wood_sword_damage() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_wood_sword_range() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_wood_sword_cooldown() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_sword_evolves_at_threshold() -> bool:
	...
	var result = sword.current_tier == SwordBase.Tier.STONE
	sword.queue_free()
	return result

# Test: Stone sword has correct damage
static func test_stone_sword_damage() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_stone_sword_range() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_iron_sword_damage() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_iron_sword_range() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_diamond_sword_damage() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_diamond_sword_range() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
...
static func test_diamond_sword_max_tier() -> bool:
	var sword = get_sword_instance()
	if not sword:
		return false
	...
	var result = sword.current_tier == SwordBase.Tier.DIAMOND
	sword.queue_free()
	return result
...
static func test_evolved_signal_emitted() -> bool:
	...
	var result = signal_received and received_tier == SwordBase.Tier.STONE
	sword.queue_free()
	return result
...
static func test_tier_name_getter() -> bool:
	...
	var result = wood_name == "Wood Sword" and diamond_name == "Diamond Sword"
	sword.queue_free()
	return result
...
static func test_full_evolution_path() -> bool:
	...
	# Start at Wood
	if sword.current_tier != SwordBase.Tier.WOOD:
		sword.queue_free()
		return false
	...
	for i in range(50):
		sword.on_enemy_killed()
	if sword.current_tier != SwordBase.Tier.STONE:
		sword.queue_free()
		return false
	...
	for i in range(150):
		sword.on_enemy_killed()
	if sword.current_tier != SwordBase.Tier.IRON:
		sword.queue_free()
		return false
	...
	for i in range(400):
		sword.on_enemy_killed()
	if sword.current_tier != SwordBase.Tier.DIAMOND:
		sword.queue_free()
		return false
