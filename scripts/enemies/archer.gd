...
class_name Archer
## Archer (弓兵) - Ranged enemy that shoots arrows at the player
...
@export var meat_drop_chance: float = 0.12  # 12% chance to drop steamed buns
...
func _setup_animator() -> void:
	...
	if sprite:
		...
		# Archer-specific animation settings: steady aim stance
...
func shoot_arrow() -> void:
	...
	if audio:
		audio.play_sfx_at("archer_arrow", global_position)
